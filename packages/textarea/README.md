...
[Storybook](https://equinor.github.io/fusion-web-components/?path=/docs/input-textarea)
...
```html
<fwc-textarea label='My Label' icon="settings" rows='3' cols='4'></fwc-textarea>
```
