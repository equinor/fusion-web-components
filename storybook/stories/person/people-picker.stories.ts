...
import { PeoplePickerElement, PickerPersonAddedEvent, PickerPersonRemovedEvent, PickerSelectionChangedEvent, type PeoplePickerElementProps } from '@equinor/fusion-wc-people';
